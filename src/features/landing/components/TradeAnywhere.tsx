...
const TradeAnywhere: React.FC = () => {
    return (
        <section className="max-w-7xl mx-auto py-24 px-4 md:px-6 overflow-hidden">
            ...
            <div className="mt-32 text-center space-y-8">
                <h3 className="text-4xl md:text-5xl font-bold text-white">Start Trading Crypto Options</h3>
                <button className="bg-yellow-400 hover:bg-yellow-500 text-slate-950 font-bold px-10 py-4 rounded-xl text-lg shadow-xl shadow-yellow-400/10 transition-all hover:scale-105 active:scale-95">
                    Open Options Account
                </button>
            </div>
        </section>
    );
